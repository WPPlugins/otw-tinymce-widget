...
if( !function_exists( 'otw_mcsw_init' ) ){
	...
	function otw_mcsw_init(){
		...
		global $otw_mcsw_plugin_url, $otw_mcsw_plugin_options, $otw_mcsw_shortcode_component, $otw_mcsw_shortcode_object, $otw_mcsw_form_component, $otw_mcsw_validator_component, $otw_mcsw_form_object, $wp_mcsw_cs_items, $otw_mcsw_js_version, $otw_mcsw_css_version, $wp_widget_factory;
		...
		$otw_mcsw_shortcode_object->shortcodes['html_editor'] = array( 'title' => __('HTML Editor', 'otw_mcsw'),'enabled' => false,'children' => false, 'parent' => false, 'order' => 125,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_mcsw_plugin_url.'/include/otw_components/otw_shortcode/', 'dialog_text' => $otw_mcsw_dialog_text   );
...
if( !function_exists( 'otw_mcsw_init_admin_menu' ) ){
	...
	function otw_mcsw_init_admin_menu(){
		...
		add_menu_page(__('OTW TinyMCE Widget', 'otw_mcsw'), __('OTW TinyMCE Widget', 'otw_mcsw'), 'manage_options', 'otw-mcsw-settings', 'otw_mcsw_settings', $otw_mcsw_plugin_url.'/images/otw-sbm-icon.png');
		add_submenu_page( 'otw-mcsw-settings', __('Settings', 'otw_mcsw'), __('Settings', 'otw_mcsw'), 'manage_options', 'otw-mcsw-settings', 'otw_mcsw_settings' );
